...
describe('Service Tests', () => {
  describe('VideoCategory Service', () => {
    ...
    let elemDefault: IVideoCategory;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(VideoCategoryService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new VideoCategory(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a VideoCategory', () => {
        ...
        service.create(new VideoCategory()).subscribe(resp => (expectedResult = resp.body));
