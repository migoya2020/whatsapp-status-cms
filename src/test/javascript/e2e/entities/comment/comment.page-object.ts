...
export class CommentUpdatePage {
  ...
  commentDateInput = element(by.id('field_commentDate'));
  ...
  async setCommentDateInput(commentDate: string): Promise<void> {
    await this.commentDateInput.sendKeys(commentDate);
  }

  async getCommentDateInput(): Promise<string> {
    return await this.commentDateInput.getAttribute('value');
  }
