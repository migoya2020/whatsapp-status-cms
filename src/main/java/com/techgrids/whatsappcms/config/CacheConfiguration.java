package com.techgrids.whatsappcms.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("whatsappstatus");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("whatsappstatus");
        ...
        config.getMapConfigs().put("com.techgrids.whatsappcms.domain.*", initializeDomainMapConfig(jHipsterProperties));
